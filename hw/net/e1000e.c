...
{
    E1000EState *s = qemu_get_nic_opaque(nc);
	printf("%s,hardware receive iov packet\n",__FUNCTION__);
...
{
    E1000EState *s = qemu_get_nic_opaque(nc);
	printf("%s,hardware receive packet\n",__FUNCTION__);
...
//	printf("%s,and addr is 0x%p\n",__FUNCTION__,e1000e_pci_realize);
    trace_e1000e_cb_pci_realize();
//	printf("into e1000e_pci_realize\n");
	...
	printf("%s,and before register msix mmio\n",__FUNCTION__);
    memory_region_init(&s->msix, OBJECT(s), "e1000e-msix",
                       E1000E_MSIX_SIZE);
	printf("%s,and medio register msix mmio\n",__FUNCTION__);
    pci_register_bar(pci_dev, E1000E_MSIX_IDX,
                     PCI_BASE_ADDRESS_SPACE_MEMORY, &s->msix);
	printf("%s,and msix mmio,its addr is 0x%lx\n",__FUNCTION__,s->msix.addr);
	printf("%s,and after register msix mmio\n",__FUNCTION__);
