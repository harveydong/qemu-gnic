...
static inline void _nocheck__trace_vfio_pci_read_config(const char * name, int addr, int len, int val)
{
    if (trace_event_get_state(TRACE_VFIO_PCI_READ_CONFIG)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_pci_read_config " " (%s, @0x%x, len=0x%x) %x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , name, addr, len, val);
    }
...
static inline void _nocheck__trace_vfio_add_ext_cap_dropped(const char * name, uint16_t cap, uint16_t offset)
{
    if (trace_event_get_state(TRACE_VFIO_ADD_EXT_CAP_DROPPED)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_add_ext_cap_dropped " "%s %x@%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , name, cap, offset);
    }
...
static inline void _nocheck__trace_vfio_pci_emulated_vendor_id(const char * name, uint16_t val)
{
    if (trace_event_get_state(TRACE_VFIO_PCI_EMULATED_VENDOR_ID)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_pci_emulated_vendor_id " "%s %04x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , name, val);
    }
...
static inline void _nocheck__trace_vfio_pci_emulated_device_id(const char * name, uint16_t val)
{
    if (trace_event_get_state(TRACE_VFIO_PCI_EMULATED_DEVICE_ID)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_pci_emulated_device_id " "%s %04x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , name, val);
    }
...
static inline void _nocheck__trace_vfio_pci_emulated_sub_vendor_id(const char * name, uint16_t val)
{
    if (trace_event_get_state(TRACE_VFIO_PCI_EMULATED_SUB_VENDOR_ID)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_pci_emulated_sub_vendor_id " "%s %04x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , name, val);
    }
...
static inline void _nocheck__trace_vfio_pci_emulated_sub_device_id(const char * name, uint16_t val)
{
    if (trace_event_get_state(TRACE_VFIO_PCI_EMULATED_SUB_DEVICE_ID)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_pci_emulated_sub_device_id " "%s %04x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , name, val);
    }
...
static inline void _nocheck__trace_vfio_quirk_nvidia_3d0_read(const char * name, uint8_t offset, unsigned size, uint64_t val)
{
    if (trace_event_get_state(TRACE_VFIO_QUIRK_NVIDIA_3D0_READ)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_quirk_nvidia_3d0_read " " (%s, @0x%x, len=0x%x) %"PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_vfio_pci_igd_bar4_write(const char * name, uint32_t index, uint32_t data, uint32_t base)
{
    if (trace_event_get_state(TRACE_VFIO_PCI_IGD_BAR4_WRITE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_pci_igd_bar4_write " "%s [%03x] %08x -> %08x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_vfio_iommu_map_notify(const char * op, uint64_t iova_start, uint64_t iova_end)
{
    if (trace_event_get_state(TRACE_VFIO_IOMMU_MAP_NOTIFY)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_iommu_map_notify " "iommu %s @ %"PRIx64" - %"PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_vfio_listener_region_add_skip(uint64_t start, uint64_t end)
{
    if (trace_event_get_state(TRACE_VFIO_LISTENER_REGION_ADD_SKIP)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_listener_region_add_skip " "SKIPPING region_add %"PRIx64" - %"PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , start, end);
    }
...
static inline void _nocheck__trace_vfio_listener_region_add_iommu(uint64_t start, uint64_t end)
{
    if (trace_event_get_state(TRACE_VFIO_LISTENER_REGION_ADD_IOMMU)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_listener_region_add_iommu " "region_add [iommu] %"PRIx64" - %"PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , start, end);
    }
...
static inline void _nocheck__trace_vfio_listener_region_add_ram(uint64_t iova_start, uint64_t iova_end, void * vaddr)
{
    if (trace_event_get_state(TRACE_VFIO_LISTENER_REGION_ADD_RAM)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_listener_region_add_ram " "region_add [ram] %"PRIx64" - %"PRIx64" [%p]" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_vfio_listener_region_del_skip(uint64_t start, uint64_t end)
{
    if (trace_event_get_state(TRACE_VFIO_LISTENER_REGION_DEL_SKIP)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_listener_region_del_skip " "SKIPPING region_del %"PRIx64" - %"PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , start, end);
    }
...
static inline void _nocheck__trace_vfio_listener_region_del(uint64_t start, uint64_t end)
{
    if (trace_event_get_state(TRACE_VFIO_LISTENER_REGION_DEL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_listener_region_del " "region_del %"PRIx64" - %"PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , start, end);
    }
...
static inline void _nocheck__trace_vfio_region_setup(const char * dev, int index, const char * name, unsigned long flags, unsigned long offset, unsigned long size)
{
    if (trace_event_get_state(TRACE_VFIO_REGION_SETUP)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_region_setup " "Device %s, region %d \"%s\", flags: %lx, offset: %lx, size: %lx" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_vfio_region_mmap_fault(const char * name, int index, unsigned long offset, unsigned long size, int fault)
{
    if (trace_event_get_state(TRACE_VFIO_REGION_MMAP_FAULT)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_region_mmap_fault " "Region %s mmaps[%d], [%lx - %lx], fault: %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_vfio_region_mmap(const char * name, unsigned long offset, unsigned long end)
{
    if (trace_event_get_state(TRACE_VFIO_REGION_MMAP)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_region_mmap " "Region %s [%lx - %lx]" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , name, offset, end);
    }
...
static inline void _nocheck__trace_vfio_prereg_listener_region_add_skip(uint64_t start, uint64_t end)
{
    if (trace_event_get_state(TRACE_VFIO_PREREG_LISTENER_REGION_ADD_SKIP)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_prereg_listener_region_add_skip " "%"PRIx64" - %"PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , start, end);
    }
...
static inline void _nocheck__trace_vfio_prereg_listener_region_del_skip(uint64_t start, uint64_t end)
{
    if (trace_event_get_state(TRACE_VFIO_PREREG_LISTENER_REGION_DEL_SKIP)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_prereg_listener_region_del_skip " "%"PRIx64" - %"PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , start, end);
    }
...
static inline void _nocheck__trace_vfio_prereg_register(uint64_t va, uint64_t size, int ret)
{
    if (trace_event_get_state(TRACE_VFIO_PREREG_REGISTER)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_prereg_register " "va=%"PRIx64" size=%"PRIx64" ret=%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , va, size, ret);
    }
...
static inline void _nocheck__trace_vfio_prereg_unregister(uint64_t va, uint64_t size, int ret)
{
    if (trace_event_get_state(TRACE_VFIO_PREREG_UNREGISTER)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_prereg_unregister " "va=%"PRIx64" size=%"PRIx64" ret=%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , va, size, ret);
    }
...
static inline void _nocheck__trace_vfio_spapr_remove_window(uint64_t off)
{
    if (trace_event_get_state(TRACE_VFIO_SPAPR_REMOVE_WINDOW)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:vfio_spapr_remove_window " "offset=%"PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , off);
    }
