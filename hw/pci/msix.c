...
//	printf("%s,and %d,device name is %s,vec is %d\n",__func__,__LINE__,dev->name,vector);
...
printf("%s,and %d,device name is %s,vec is %d,msg data is 0x%x\n",__func__,__LINE__,dev->name,vector,msg.data);
